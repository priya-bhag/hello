...
public class DynamicUIobjectTest extends FunctionCallingTest{
...
public void testMyFirst() throws FileNotFoundException, IOException, InterruptedException{
			...
			DynamicUIobjectTest  obj = new DynamicUIobjectTest();
...
String order_no=driver.findElement(By.id(prop.getProperty("text_BookingConfirmation_OrderNo"))).getAttribute("value");
...
driver.findElement(By.linkText(prop.getProperty("link_BookingConfiramtion_BookedItenary"))).click();



driver.findElement(By.xpath(prop.getProperty("text_BookedItenary_Search_order_Id"))).sendKeys(order_no);
...
driver.findElement(By.id(prop.getProperty("button_BookedItenary_go"))).click();




driver.findElement(By.xpath(".//*[starts-with(@id,'btn_id_')]")).click();
