...
public class synchronization_WEbDriver_wait extends FunctionCallingTest{
...
public void testMyFirst() throws FileNotFoundException, IOException, InterruptedException{
			...
			synchronization_WEbDriver_wait  obj = new synchronization_WEbDriver_wait();
...
wt.until(ExpectedConditions.elementToBeClickable(By.linkText(prop.getProperty("link_Book_a_hotel_Logout"))));
